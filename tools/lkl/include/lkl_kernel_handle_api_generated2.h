...
int (*dce_lkl_ifname_to_ifindex)(const char *name);
long (*dce_lkl_mount_blkdev)(unsigned int dev, const char *fs_type, int flags,const char *opts, char *mnt_str, unsigned int mnt_str_len); 
...
int (*dce_lkl_qdisc_add)(int ifindex, const char *root, const char *type);
void (*dce_lkl_qdisc_parse_add)(int ifindex, const char *entries);
...
long (*dce_lkl_umount_blkdev)(unsigned int dev, int flags, long timeout_ms);
